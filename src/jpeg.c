...
static boolean fill_input_buffer(j_decompress_ptr cinfo)
{
   ...
   // 수정 전
//jpeg->Start_Ofs = (ulong_t) jpeg->cinfo.src->next_input_byte - (ulong_t) jpeg->Data;

// 수정 후
jpeg->Start_Ofs = (uintptr_t) jpeg->cinfo.src->next_input_byte - (uintptr_t) jpeg->Data;
#endif
      if (jpeg->Skip) {
